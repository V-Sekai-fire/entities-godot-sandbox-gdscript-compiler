...
TEST_CASE("range numbers are written as the engine writes them") {
...
TEST_CASE("a hint survives the other annotations") {
...
TEST_CASE("constant expressions are not errors") {
	struct Case {
		const char *source;
		const char *what;
	};
